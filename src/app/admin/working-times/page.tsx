...
export default function WorkingTimesPage() {
  ...
  return (
    <section className="space-y-6">
      <header>
        <h1 className="text-2xl font-semibold text-white">Working times</h1>
        <p className="mt-2 text-sm text-slate-300">Manage weekly working-hour windows for booking availability.</p>
      </header>
