  ...
  return (
    <section className="max-w-4xl space-y-10 text-slate-100">
      <div>
        ...
        <p className="mt-2 text-sm text-slate-300">Upload homepage background images, deposit requirements, email server settings, weekly working-hours windows, and calendar blockouts.</p>
      </div>
