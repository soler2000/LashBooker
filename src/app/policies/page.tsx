  ...
  return (
    <main className="mx-auto max-w-3xl p-8">
      <header>
        ...
        <p className="mt-3 text-sm text-gray-600">Please review these policies before booking your appointment.</p>
        <p className="mt-1 text-xs text-gray-500">Last updated: {LAST_UPDATED}</p>
      </header>
      ...
      <section className="mt-8">
        <h2 className="text-xl font-semibold">Cancellation windows</h2>
        <ul className="mt-3 list-disc space-y-2 pl-5 text-sm text-gray-800">
      ...
      <section className="mt-8">
        <h2 className="text-xl font-semibold">Prep guidance</h2>
        <ul className="mt-3 list-disc space-y-2 pl-5 text-sm text-gray-800">
      ...
      <section className="mt-8">
        <h2 className="text-xl font-semibold">Aftercare guidance</h2>
        <ul className="mt-3 list-disc space-y-2 pl-5 text-sm text-gray-800">
